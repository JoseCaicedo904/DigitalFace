  ...
  return (
    <div className="bg-white">
      ...
      {/* The reference details close the page. Everything above asks for the
          message or the booking; this is what a visitor checks afterwards. */}
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <Card className="border-ink-100 bg-white/95 shadow-brand-card">
              <CardContent className="space-y-3 p-6">
                ...
                <p className="text-sm text-ink-500">{t.cards.response.body}</p>
            ...
            <Card className="border-ink-100 bg-white/95 shadow-brand-card">
              <CardContent className="space-y-3 p-6">
                ...
                <p className="text-sm text-ink-500">{t.cards.location.body}</p>
                <p className="text-xs text-ink-400">{t.cards.location.hint}</p>
              </CardContent>
            </Card>
            <Card className="border-ink-100 bg-white/95 shadow-brand-card">
              <CardContent className="space-y-3 p-6">
